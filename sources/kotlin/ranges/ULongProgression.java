...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1364getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return ((int) (this.step ^ (this.step >>> 32))) + (((((int) ULong.m329constructorimpl(this.first ^ ULong.m329constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m329constructorimpl(this.last ^ ULong.m329constructorimpl(this.last >>> 32)))) * 31);
    }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1390fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
