...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m1615markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1624constructorimpl(read());
    }
    ...
    public final long m1613differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1612adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1624constructorimpl(LongSaturatedMathKt.m1610saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
