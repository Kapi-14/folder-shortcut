...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1617plusAssignLRDsOJo(long duration) {
        long longDelta = Duration.m1527toLongimpl(duration, getUnit());
        ...
        long $this$isSaturated$iv = Duration.m1527toLongimpl(half, getUnit());
        if (!((($this$isSaturated$iv - 1) | 1) == Long.MAX_VALUE)) {
            long readingBefore = this.reading;
            try {
                m1617plusAssignLRDsOJo(half);
                m1617plusAssignLRDsOJo(Duration.m1516minusLRDsOJo(duration, half));
                return;
    ...
    private final void m1616overflowLRDsOJo(long duration) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + DurationUnitKt.shortName(getUnit()) + " is advanced by " + ((Object) Duration.m1530toStringimpl(duration)) + '.');
    }
}
