...
public final class UProgressionUtilKt {
    ...
    private static final int m1362differenceModuloWZ9TVnA(int a, int b, int c) {
        int compare;
        ...
        return UInt.m250constructorimpl(compare >= 0 ? ac - bc : UInt.m250constructorimpl(ac - bc) + c);
    }

    /* renamed from: differenceModulo-sambcqE, reason: not valid java name */
    private static final long m1363differenceModulosambcqE(long a, long b, long c) {
        int compare;
        ...
        return ULong.m329constructorimpl(compare >= 0 ? ac - bc : ULong.m329constructorimpl(ac - bc) + c);
    }

    /* renamed from: getProgressionLastElement-Nkh28Cs, reason: not valid java name */
    public static final int m1365getProgressionLastElementNkh28Cs(int start, int end, int step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Integer.compare(start ^ Integer.MIN_VALUE, end ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return UInt.m250constructorimpl(end - m1362differenceModuloWZ9TVnA(end, start, UInt.m250constructorimpl(step)));
            }
        } else {
            if (step >= 0) {
            ...
            if (compare > 0) {
                return UInt.m250constructorimpl(m1362differenceModuloWZ9TVnA(start, end, UInt.m250constructorimpl(-step)) + end);
            }
        }
        return end;
    }
    ...
    public static final long m1364getProgressionLastElement7ftBX0g(long start, long end, long step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Long.compare(start ^ Long.MIN_VALUE, end ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return ULong.m329constructorimpl(end - m1363differenceModulosambcqE(end, start, ULong.m329constructorimpl(step)));
            }
        } else {
            if (step >= 0) {
                throw new IllegalArgumentException("Step is zero.");
            ...
            if (compare > 0) {
                return ULong.m329constructorimpl(m1363differenceModulosambcqE(start, end, ULong.m329constructorimpl(-step)) + end);
            }
        }
        return end;
    }
