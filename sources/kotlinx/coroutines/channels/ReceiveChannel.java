...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1662tryReceivePtdJZtk = receiveChannel.mo1662tryReceivePtdJZtk();
            if (ChannelResult.m1678isSuccessimpl(mo1662tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1674getOrThrowimpl(mo1662tryReceivePtdJZtk);
            }
            Throwable m1672exceptionOrNullimpl = ChannelResult.m1672exceptionOrNullimpl(mo1662tryReceivePtdJZtk);
            if (m1672exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1672exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1661receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1673getOrNullimpl(r3)
                return r3
            */
