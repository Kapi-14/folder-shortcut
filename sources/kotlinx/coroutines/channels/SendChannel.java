...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1663trySendJP2dKIU(e);
            if (ChannelResult.m1678isSuccessimpl(result)) {
                return true;
            }
            Throwable m1672exceptionOrNullimpl = ChannelResult.m1672exceptionOrNullimpl(result);
