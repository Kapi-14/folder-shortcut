    ...
    public static Map<Integer, Integer> quantize(int[] inputPixels, int[] startingClusters, int maxColors) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                double d = componentASums2[clusterIndex];
                double d2 = point2[c];
                double d3 = count;
                Double.isNaN(d3);
                componentASums2[clusterIndex] = d + (d2 * d3);
                double d4 = componentBSums[clusterIndex];
                double d5 = point2[1];
                int pointsMoved3 = pointsMoved;
                double d6 = count;
                Double.isNaN(d6);
                componentBSums[clusterIndex] = d4 + (d5 * d6);
                double d7 = componentCSums[clusterIndex];
                double d8 = point2[2];
                double[] componentBSums2 = componentBSums;
                double d9 = count;
                Double.isNaN(d9);
                componentCSums[clusterIndex] = d7 + (d8 * d9);
                i9++;
            ...
            double[] componentBSums3 = componentBSums;
            ...
            while (i10 < clusterCount) {
                ...
                if (count2 == 0) {
                    ...
                    double d10 = componentASums2[i10];
                    double d11 = count2;
                    Double.isNaN(d11);
                    double a = d10 / d11;
                    double d12 = componentBSums3[i10];
                    pointCount2 = pointCount;
                    double d13 = count2;
                    Double.isNaN(d13);
                    double b = d12 / d13;
                    double d14 = componentCSums[i10];
                    componentASums = componentASums2;
                    pixelCountSums2 = pixelCountSums3;
                    double d15 = count2;
                    Double.isNaN(d15);
