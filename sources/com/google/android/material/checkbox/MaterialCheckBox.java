...
public class MaterialCheckBox extends AppCompatCheckBox {
        ...
        if (Build.VERSION.SDK_INT < 21 && this.buttonIconDrawable != null) {
            post(new Runnable() { // from class: com.google.android.material.checkbox.MaterialCheckBox$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MaterialCheckBox.this.m64xdf87d0bf();
                }
            });
        }
    }
    ...
    public /* synthetic */ void m64xdf87d0bf() {
    ...
    private void updateIconTintIfNeeded() {
        if (Build.VERSION.SDK_INT < 21 && this.buttonIconDrawable != null && this.buttonIconTintList != null) {
            this.buttonIconDrawable.setColorFilter(DrawableUtils.updateTintFilter(this.buttonIconDrawable, this.buttonIconTintList, this.buttonIconTintMode));
        }
    }
