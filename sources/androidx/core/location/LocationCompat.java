    ...
    private static class Api26Impl {
        ...
        static void removeVerticalAccuracy(Location location) {
            try {
                ...
                LocationCompat.getFieldsMaskField().setByte(location, (byte) ((LocationCompat.getHasVerticalAccuracyMask() ^ (-1)) & fieldsMask));
        ...
        static void removeSpeedAccuracy(Location location) {
            try {
                byte fieldsMask = LocationCompat.getFieldsMaskField().getByte(location);
                LocationCompat.getFieldsMaskField().setByte(location, (byte) ((LocationCompat.getHasSpeedAccuracyMask() ^ (-1)) & fieldsMask));
            } catch (IllegalAccessException e) {
                Error error = new IllegalAccessError();
                error.initCause(e);
                throw error;
        ...
        static void removeBearingAccuracy(Location location) {
            try {
                byte fieldsMask = LocationCompat.getFieldsMaskField().getByte(location);
                LocationCompat.getFieldsMaskField().setByte(location, (byte) ((LocationCompat.getHasBearingAccuracyMask() ^ (-1)) & fieldsMask));
            } catch (IllegalAccessException e) {
                Error error = new IllegalAccessError();
                error.initCause(e);
                throw error;
