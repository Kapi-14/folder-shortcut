...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    */
    ...
    public void onExitLayoutOrScroll(boolean enableChangeEvents) {
        ...
        if (this.mLayoutOrScrollCounter < 1) {
            if (sDebugAssertionsEnabled && this.mLayoutOrScrollCounter < 0) {
    ...
    */
    ...
    private float getSplineFlingDistance(int velocity) {
        ...
        Double.isNaN(d);
        double decelMinusOne = d - 1.0d;
        double d2 = this.mPhysicalCoef * SCROLL_FRICTION;
        double d3 = DECELERATION_RATE;
        Double.isNaN(d3);
        double exp = Math.exp((d3 / decelMinusOne) * l);
        Double.isNaN(d2);
        return (float) (d2 * exp);
    }
