...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        if (i2 >= 0 && this.mBarrierType < 4) {
            ...
            boolean applyEqualityOnReferences = (hasMatchConstraintWidgets || !((this.mBarrierType == 0 && mHasHorizontalCenteredDependents) || ((this.mBarrierType == 2 && mHasVerticalCenteredDependents) || ((this.mBarrierType == 1 && mHasHorizontalCenteredDependents) || (this.mBarrierType == 3 && mHasVerticalCenteredDependents))))) ? false : USE_RESOLUTION;
