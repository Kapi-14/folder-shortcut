    ...
    */
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = append.append(((int) (r2 + 0.5d)) / 100.0f).toString();
            getTextBounds(text, this.mTextPaint);
            ...
            String text2 = append2.append(((int) (r2 + 0.5d)) / 100.0f).toString();
        ...
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != this.mTransitionLastPosition))) {
            ...
            while (i < n2) {
                ...
                if (frame == null) {
                    ...
                    newState2 = newState3;
                    n = n2;
                    this.mKeepAnimating |= frame.interpolate(child, interPos, time2, this.mKeyCache);
                }
                i++;
                newState3 = newState2;
                n2 = n;
