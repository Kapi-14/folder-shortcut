...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    private boolean updateAppConfiguration(int nightMode, LocaleListCompat locales, boolean allowRecreation) {
        ...
        if (((activityHandlingConfigChange ^ (-1)) & configChanges) != 0 && allowRecreation && this.mBaseContextAttached && ((sCanReturnDifferentContext || this.mCreated) && (this.mHost instanceof Activity) && !((Activity) this.mHost).isChild())) {
